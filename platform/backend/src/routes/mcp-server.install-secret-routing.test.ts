...
/**
THESE TESTS ARE COVERING EXISTING BEHAVIOUR AND EXISTS TO MAKE SURE WE DON'T BREAK IT ACCIDENTALLY.
THERE ARE COUPLE OF WEIRDNESS REGARDING HOW SECRETS ARE STORED (e.g. per user prompted non-secrets are anyway stored in the secret table).
IT'S OK TO FIX IT.
 */
